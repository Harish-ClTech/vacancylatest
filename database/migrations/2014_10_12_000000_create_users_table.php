...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->integer('personal_enabled')->default(0);
            $table->integer('other_enabled')->default(0);
            $table->integer('contact_enabled')->default(0);
            $table->integer('education_enabled')->default(0);
            $table->integer('training_enabled')->default(0);
            $table->integer('experience_enabled')->default(0);
            $table->integer('document_enabled')->default(0);
