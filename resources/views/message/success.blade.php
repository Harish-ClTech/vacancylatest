  ...
  <body>
    <div class="sucess_card d-flex flex-column justify-content-center">
      <div class="tick_logo text-center  mb-4">
        <i class="fa-solid fa-check border border-success rounded-circle p-3 text-white fs-2 bg-success "></i>
      </div>
      ...
      <div class="payment_detail mb-3 mt-2 text-center " style="border-radius:3px">
        <p class="m-0 fw-bold">Your request has been processed successfully</p>
        <p class="opacity-75" style="font-size: 14px;"> Please visit your Profile for further details. <br> Thank You!</p>
      </div>
